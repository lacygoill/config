...
# Requirement: All `fish_color_*` variables must be set in the universal cope.{{{
#
# Otherwise, `$ fish_indent --ansi` would not work.
# The output would no longer be colorized.
#}}}
...
function set_color_no_bold_in_console --argument-names=token color
    if test -z "$DISPLAY"
        set_universal fish_color_$token $color
    else
        set_universal fish_color_$token --bold $color
    end
end
...
set_universal fish_pager_color_progress --reverse magenta
...
#}}}
set_universal fish_pager_color_background --background=FFD7D7

# the base string being completed (for every match in the pager)
set_universal fish_pager_color_prefix green

# the completing string (for every match in the pager)
set_universal fish_pager_color_completion --dim gray

# the description (for every match in the pager)
set_universal fish_pager_color_description --dim gray

# background of the selected match
set_universal fish_pager_color_selected_background --background=black --dim

# description of the selected match
set_universal fish_pager_color_selected_description FFD7D7

# prefix of the selected match
set_universal fish_pager_color_selected_prefix white
# suffix of the selected match
set_universal fish_pager_color_selected_completion white
...
# auto-suggestion
set_universal fish_color_autosuggestion 6B705C
...
#                ✔
#}}}
set_universal fish_color_cancel red
...
# command parameter
set_universal fish_color_param blue

# comment{{{
#
#     :echo hlget('Comment', v:true)[0].guifg
#}}}
set_universal fish_color_comment 5F875F
...
#     #d7875f
#}}}
set_universal fish_color_escape D7875F
...
#}}}
set_universal fish_color_search_match --background=white

# IO redirections like `>/dev/null`{{{
#
#     :echo hlget('Operator', v:true)[0].guifg
#}}}
set_universal fish_color_redirection AF5F5F
...
#}}}
set_universal fish_color_quote 008787
...
#}}}
set_universal fish_color_valid_path --underline
...
#}}}
set_universal fish_color_cwd blue

# exit statuses of all processes that made up last executed pipe
set_universal fish_color_status '--background=red' 'white'
