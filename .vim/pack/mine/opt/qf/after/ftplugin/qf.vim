...
import autoload '../../autoload/qf/saveRestore.vim'
import autoload 'configgrep.vim'
...
command -bang -buffer -nargs=? -complete=custom,configgrep.Complete Cfilter qf.Cfilter(<bang>0, <q-args>, <q-mods>)
