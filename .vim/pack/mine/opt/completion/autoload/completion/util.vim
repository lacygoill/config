...
export def CustomIsk(chars: string): bool #{{{1
    # Why this check?{{{
    #
    ...
    try
        ...
        augroup CompletionUtilRestoreIsk
            autocmd!
...
export def SetupDict(): bool #{{{1
    ...
    augroup CompletionDictRestoreIc
        autocmd!
