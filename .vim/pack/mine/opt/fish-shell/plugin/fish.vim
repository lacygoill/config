...
if getenv('__my_fish_config_dir') == null
    finish
endif

var conf_files: list<string> = [$__my_fish_config_dir .. '/config.fish']
    + readdir($__my_fish_config_dir .. '/conf.d/')
    ->map((_, v: string) => $__my_fish_config_dir .. '/conf.d/' .. v)
