...
def IsSpecial(): bool #{{{2
    ...
    return &l:previewwindow
        || &l:diff
        || ['gitcommit']->index(getbufvar(buf, '&filetype')) >= 0
...
nnoremap <unique> <C-W>J <ScriptCmd>wincmd J <Bar> doautocmd <nomodeline> WinEnter<CR>
nnoremap <unique> <C-W>K <ScriptCmd>wincmd K <Bar> doautocmd <nomodeline> WinEnter<CR>
