# Purpose: Use the final version of  `electric_car.py` from this section.  Add a
# method to the `Battery` class  called `upgrade_battery()`.  This method should
# check the battery size  and set the capacity to 65 if  it isn't already.  Make
