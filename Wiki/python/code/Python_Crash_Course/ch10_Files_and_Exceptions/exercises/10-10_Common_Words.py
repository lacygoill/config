# Purpose: Visit Project Gutenberg (https://gutenberg.org) and find a few texts
# you'd like to analyze.   Download the text files for these  works, or copy the
# raw text from your browser into a text file on your computer.  You can use the
...
for filename in ['Frankenstein.txt', 'Moby_Dick.txt', 'Wuthering_Heights.txt']:
    path = Path(filename)
